...
export const RATING_CORRECT = 0.3;
export const RATING_WRONG = -0.5;
export const RATING_TIMEOUT = -0.4;

// Score
export const SCORE_PER_SERVE = 100;
...
export const DIFFICULTY_RAMP_RATE = 0.03; // seconds decrease per second elapsed

// Customer colors (no yellow/brown/orange - those overlap with drink colors)
export const CUSTOMER_COLORS = [
  '#e06090', '#50b0e0', '#70c070', '#b050e0',
  '#c070c0', '#e08080', '#60d0b0', '#a0d0f0',
];
